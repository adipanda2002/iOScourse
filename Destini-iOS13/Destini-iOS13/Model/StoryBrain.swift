...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) {
        if userChoice == self.currentStory().choice1 {
            currentStoryNumber = self.currentStory().choice1Destination
        } else if userChoice == self.currentStory().choice2 {
            currentStoryNumber = self.currentStory().choice2Destination
        } 
    }
